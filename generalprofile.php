...
checklogin();
$conn=connect();
$snum=testandcheck($_GET['sno']);
$sql = "SELECT * FROM Sheet1 where sno=$snum ";
$result= mysqli_query($conn, $sql);
 $row= mysqli_fetch_assoc($result);

if(mysqli_num_rows($result)==0)
{  echo("<script>");
  echo(" alert(\"Invalid scholar number\");");
  echo("window.location.href = 'dashboardfinal.php'");
  echo("</script> ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" style="background: linear-gradient( #F2F3F4, #FDFEFE);">
            <div class="conpro" >
                <div class="containi">
 <?php    echo' <img src="studentimages/'.$row['sno'].'.jpg" alt="'.$row['sno'].'" class="schimg" id="imag"> ';  ?>
               ...
               <h1 style="position: relative;left: 20px;top: 75px; font-size:30px;width: auto;"><?php echo ucwords(strtolower($row["name"])) ; ?> </h1><br>
            
                <div class="wrapper" style="padding-left: 10px;border-radius: 5px;padding-right: 5px">
                    <i class="far fa-id-badge"></i><span itemprop="scholar"> <b><?php echo$row["sno"] ?></b></span><br><br>
                    ...
                    <i class="fas fa-home"></i><span><b> <?php if(strtolower(str_replace(' ', '',$row['res_status'])) == "dayscholar" ) echo "Day Scholar"; else echo "Hosteller";  ?></b>  </span>

                </div> 
            </div>
            <div class="bio" style="word-wrap: break-word;">
                <h1 style="border-bottom: solid;border-width: thin;">Profile</h1>
                <h5>Name:&nbsp;<?php echo ucwords(strtolower($row['name'])) ; ?></h5>
                <h5><i class="fa fa-birthday-cake" style="color: pink;" ></i> :&nbsp;&nbsp;<?php echo $row["dob"]?></h5>
                <h5><i class="fa fa-mobile-phone" style="font-size: 30px"></i> :&nbsp;&nbsp;&nbsp;<?php echo $row["cno"]?></h5>
                <h5><i class="far fa-address-card"></i> :&nbsp;&nbsp;<?php if(strtolower(str_replace(' ', '',$row['res_status'])) == "dayscholar" ) echo "Day Scholar"; else echo "Hosteller";  ?></h5>
