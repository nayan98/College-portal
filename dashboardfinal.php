...
button.button:hover {
  color: #fff;
    ...
    <body>
        ...
        <div class="container-fluid" style="background: linear-gradient( #F2F3F4, #FDFEFE);">
            ...
            <div class="bio" >
                <h1 style="background-color: #2E4053;color: #BDC3C7;border-radius: 5px">Hey <?php echo ucwords(strtolower($_SESSION["name"])) ; ?> !</h1>
                <button class="button" data-modal="#modalOne" style="margin-top: 150px;">Compare Your Result</button><br>
                <button class="button" data-modal="#modalThree" style="margin-top: 100px;"><b>FeedBack</b> <i class="far fa-smile" style="font-size: 25px;color: #52BE80"></i></button>
  ...
  <div class="modal-content">
    <div class="contact-form">
      ...
      <h2>Compare Result</h2><br>
    </div>
  <div class="modal-body">
      <form action="" >
          <input class="input100" type="text" name="sno" required placeholder="Scholar number" style="border-radius: 5px;border: solid #000000;border-width: thin">
    <button type="submit" class="button" data-modal="#modalTwo" style="float: right; padding: 0;min-width: 80px;min-height: 30px">Compare</button><br>
      </form>
...
<div id="modalTwo" class="modal">
  ...
  <div class="modal-body">
    <textarea rows="4" cols="50" name="comment" form="usrform" style="border-radius: 5px" placeholder="Enter your feedback here...">
</textarea>
      <form action="" id="usrform">
  <input type="submit" class="butt"style="background: linear-gradient(#000000,#2C3E50);color: #fff;border: none;border-radius: 5px;min-width: 80px;min-height: 30px;float: right">
</form>
  </div>
  </div>
</div>
        ...
        var modall = document.getElementById('imgmodal');
